...
export const NoteItem = memo(
    ({
        ...
        const isUpcoming = note.type === 'reminder' && note.reminder_at && note.reminder_at > Date.now();

        return (
            <View style={[styles.noteCard, darkStyles.card]}>
...
const styles = StyleSheet.create({
    ...
    noteTitle: { flex: 1, fontSize: 18, ...fonts.fontSemiBold },
    pinButton: {
        padding: 4,
    },
